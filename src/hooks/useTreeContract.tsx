      ...
      axios.post(`${api.url}/forest/transactions/new`,
        ...
        .then(response => {
          if (response.status === 201) {
           ...
           alert('The token was minted successfully')
          } else {
            alert('The token could not be minted')
          }
        })
    })
  }
